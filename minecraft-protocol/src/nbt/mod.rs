...
//!
//! ```
//! use minecraft_protocol::nbt::decode::read_compound_tag;
//! use std::io::Cursor;
//!
...
//!
//! ```
//! use minecraft_protocol::nbt::encode::write_compound_tag;
//! use minecraft_protocol::nbt::CompoundTag;
//!
...
mod tests {
    ...
    fn test_compound_tag_nested_compound_tag_vec() {
        ...
        compound_tag
            .insert_compound_tag_vec("nested_compound_tag_vec", insert_nested_compound_tag_vec);
    ...
    #[test]
    fn test_servers_fmt() {
        use crate::nbt::decode::read_compound_tag;
        use std::io::Cursor;
    ...
    #[test]
    fn test_player_fmt() {
        use crate::nbt::decode::read_gzip_compound_tag;
        use std::io::Cursor;
